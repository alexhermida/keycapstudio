...
The header links to the [GitHub repository](https://github.com/alexhermida/keycapstudio). Its Thangs button temporarily points to the Thangs homepage and is labeled “soon”; replace `THANGS_URL` in `src/App.tsx` with the creator profile URL once published.
