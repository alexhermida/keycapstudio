...
- Follow up on the improved but still raised adaptive-width print: inspect a close-up and matching slice, and check icon detail, socket fit, and travel. The toolpath comparison supports a slicing-related overpacking hypothesis, but the remaining physical cause is not confirmed.
