...
- Print the 8 mm OEM Spark 3MF from `_tmp/oem-template-comparison/keyv2_oem_row5_same_svg.3mf` as the combined fit and inlay trial. Compare seating, height, retention, removal, full travel, clearance, and legend flushness with the original cap and current working sample. Inspect assembled parts, material assignment, and support/toolpath coverage in the slicer first. Keep the current web geometry until physical evidence supports an adoption decision.
