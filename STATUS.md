...
- Gate A: print the corrected KeyV2 blank and compare seating, height, retention, removal, full travel, and clearance with the original cap and the current working sample. Do not adopt it in the web app until physical feedback and the later inlay gate support that decision.
