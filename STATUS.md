...
- KeyV2 comparison inputs are pinned to revision `19f0d2faadd4949634c93f38d1a66869d29e8f43`, with an explicit `oem_row(5, 0)` recipe in `docs/plans/`. The recipe uses `OPENSCADPATH` for the KeyV2 library path; no KeyV2 STL or comparison measurements exist yet.
